...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        
        {
            ...
            $crud->registrarse($nombres, $apellidos, $telefono, $rol, $correo, $usuario , $contraseña);
...
<video autoplay muted loop>
    ...
    <div class="container">
        ...
        <form action="registrarse.php" method="post">
            ...
            <input type="text" id="rol " name="rol" placeholder="Rol" required><br>
            ...
            <label for="label" class="" style="margin-top: 5px;">¿Ya tienes una cuenta? <a href="index.php">Ingresa</a></label>
